...
# Kali linux   COPY TO: /usr/share/metasploit-framework/modules/post/windows/escalate/enigma_fileless_IsolatedCommand.rb
# Ubuntu linux COPY TO: /opt/metasploit/apps/pro/msf3/modules/post/windows/escalate/enigma_fileless_IsolatedCommand.rb
...
# -----------------------------------------
        def initialize(info={})
                super(update_info(info,
                        'Name'          => 'j0nk0 enigma fileless uac bypass [sdclt.exe]',
                        'Description'   => %q{
